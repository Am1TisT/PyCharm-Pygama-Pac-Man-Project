...
class Background(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.sheet.set_clip(pygame.Rect(371, 4, 164, 212))
...
class Flicker_Bacground(pygame.sprite.Sprite):
    def __init__(self, x, y): 
        super().__init__()
        self.sheet = pygame.image.load(Texture_pack).convert()
        self.sheet.set_clip(pygame.Rect(202, 4, 164, 212))
...
def Generate_Stage(x, y):
    ...
    Generate_Wall(x+180, y+540, 80, 10)
    Generate_Wall(x+180, y+580, 80, 10)
    ...
    Generate_Wall(x+180, y+540, 10, 50)
    Generate_Wall(x+220, y+540, 10, 50)
    ...
    Generate_Wall(x+180, y+540, 100, 50, True, False)
